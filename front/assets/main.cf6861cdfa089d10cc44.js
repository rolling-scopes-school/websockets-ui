!(function (e) {
  function t(t) {
    for (var n, s, l = t[0], u = t[1], i = t[2], d = 0, f = []; d < l.length; d++)
      (s = l[d]), Object.prototype.hasOwnProperty.call(a, s) && a[s] && f.push(a[s][0]), (a[s] = 0);
  ...
  207: function (e, t, r) {
    ...
    (u.hasChildNodes() ? o.default.hydrate : o.default.render)(
      a.default.createElement(s.BrowserRouter, null, a.default.createElement(l.default, null)),
      u
    );
  },
  216: function (e, t, r) {
        ...
        return (
          ...
          (t.prototype.render = function () {
            return s.default.createElement(
              i.Space,
              { direction: "vertical", style: { display: "flex", width: "1024px" } },
              s.default.createElement(i.Card, null, " ", s.default.createElement(l.default, null)),
              s.default.createElement(i.Card, null, " ", s.default.createElement(u.default, null))
            );
          }),
          t
        );
          ...
          function () {
            if (null !== O) {
              ...
              if ("mouse_position" === e[0]) {
                ...
                console.log(r), (document.getElementById("screen_wrapper").src = "data:image/png;base64," + r);
              }
              i(function (e) {
                return e.concat(O);
              });
        ...
        var S = function (e) {
            switch (e.key) {
              ...
              case "c":
                ...
                break;
              case "p":
                e.ctrlKey ? (e.preventDefault(), _("prnt_scrn")) : _("mouse_position");
            }
          },
        ...
        return s.default.createElement(
          ...
          s.default.createElement(
            ...
            s.default.createElement(
              ...
              s.default.createElement(
                u.Form,
                { form: k, name: "control-hooks", onFinish: C, initialValues: { wsocketUrl: "localhost" } },
                s.default.createElement(
                  u.Form.Item,
                ...
                s.default.createElement(
                  u.Form.Item,
                  null,
                  s.default.createElement(u.Button, { type: "primary", htmlType: "submit" }, "Submit")
                )
              )
            )
          ),
          s.default.createElement(
            ...
            s.default.createElement("img", { id: "screen_wrapper", style: { width: "200px", height: "200px" } }),
            s.default.createElement(
              u.Card,
              { title: "Status and history", size: "small" },
              s.default.createElement("div", null, "The WebSocket is currently ", M),
              s.default.createElement("div", null, "Last command: ", O ? O.data.split(" ")[0] : null),
              s.default.createElement(
                "div",
                ...
                o.reverse().map(function (e, t) {
                  return s.default.createElement(
                    "span",
                    { key: t },
                    e ? s.default.createElement("div", null, e.data.split(" ")[0]) : null
                  );
                })
              )
            )
      ...
      (t.default = function () {
        var e = l.useRef(null),
          ...
          b = function (e) {
            ...
            t.beginPath(), t.moveTo.apply(t, n), (t.strokeStyle = f), (t.lineWidth = r);
          },
          h = function (e) {
            if ("mousemove" !== e.type || m) {
              var t = e.currentTarget.getContext("2d"),
                r = u.getTouchPosition(e);
              t.lineTo.apply(t, r), t.stroke(), t.closePath(), t.beginPath(), t.moveTo.apply(t, r);
            }
          },
          j = function (e) {
          ...
          v = function () {
            if (e.current) {
              ...
              var n = getComputedStyle(document.body).getPropertyValue("--canvas-background");
              (r.fillStyle = n), r.fillRect(0, 0, t.width, t.height), (r.fillStyle = "transparent");
            }
          };
        return (
          l.useEffect(
  ...
  316: function (e, t, r) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.BrushSizeButton = t.getSize = t.brushSizes = void 0);
    var s = o(r(0));
    function l(e) {
    ...
    function u(e) {
      ...
      return s.default.createElement(
        "button",
        n({ type: "button", title: t, className: "BrushSizeButton " + (null != r ? r : "") }, o),
        s.default.createElement("span", { style: { width: l(t) + "px" } })
      );
    }
    (t.brushSizes = { "Ultra Small": 2, Small: 4, Medium: 6, Large: 8, "Extra Large": 10 }),
      (t.getSize = l),
      (t.BrushSizeButton = u),
      (t.default = u);
  },
  317: function (e, t, r) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.BrushColorButton = t.getColor = t.brushColors = void 0);
    var s = o(r(0));
    function l(e) {
    ...
    function u(e) {
      ...
      return s.default.createElement(
        "button",
        n({ type: "button", title: t, className: "BrushColorButton " + (null != r ? r : "") }, o),
  ...
  318: function (e, t, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.getTouchPosition = void 0);
    var n = function (e) {
    ...
    (t.getTouchPosition = function (e) {
      var t,
        ...
        a = r.left,
        o = r.top;
      return [(t = e.type.startsWith("mouse") ? n((e = e)) : n((e = e).touches[0]))[0] - a, t[1] - o];
    }),
